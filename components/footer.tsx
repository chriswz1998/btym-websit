...
const Footer = () => {
    return (<div className={ 'bg-mask-color5 md:grid grid-cols-3 text-white px-10 py-20' }>
        <div className="grid-cols-1 px-5 space-y-4 hidden md:block">
            <Logo/>
            <p>
                博泰移民 ( BoTa Visa )
                <br/>
        ...
        <div className="grid-cols-1 space-y-6 mt-10 md:m-0">
            ...
            <div className={ 'space-y-4' }>
                <div className={ 'space-y-3' }>
                    <div className="border-b pb-3">
                        ...
                        <p className="flex items-center text-xs"><Phone size={ 15 } className="mr-1"/> +1(604)780-8711
                        </p>
                    </div>
                    <div className="border-b pb-3">
                        ...
                        <p className="flex items-center text-xs"><Phone size={ 15 } className="mr-1"/> +1(204)615-6555
                        </p>
                    </div>
                    <div className="border-b pb-3">
                        ...
                        <p className="flex items-center text-xs"><Phone size={ 15 } className="mr-1"/> +1(416)880-9868
                        </p>
                    </div>
                </div>
