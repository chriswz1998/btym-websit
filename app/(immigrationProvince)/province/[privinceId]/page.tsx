...
const data_url = [
    {
        province: 'ontario',
        url: 'https://api.npoint.io/a265a7aba90f8338908e'
    },
    {
...
const ProvinceIdPage = ({params}: { params: { privinceId: string } }) => {
    ...
    const filter_url = () => {
        const [data] = data_url.filter(
            (item) => item.province === params.privinceId)
        return data.url
    }
        ...
        <div>
            ...
            <div className={'px-20 min-[1980px]:w-[1980px] mx-auto'}>
                ...
                </div>
                {
                  ...
                  <span
                      className={'text-[56px] text-default-blue font-bold'}>0{Index +
                      1}</span>
                                                        <span
