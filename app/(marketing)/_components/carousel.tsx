                ...
                <Carousel plugins={ [ Autoplay({ delay: 2000 }) ] } className={ 'w-full h-full bg-v1-bg1' }>
                    <CarouselContent>
                        <CarouselItem className="flex items-center justify-center w-fit h-[550px] ">
                            <div className="text-center space-y-6 text-white" onClick={() => route.push('/business/BCPNP-EI')}>
                        ...
                        <CarouselItem className="flex items-center justify-center w-fit h-[550px] ">
                            <div className="text-center space-y-6 text-white" onClick={() => route.push('/business/SINP-EI')}>
                        ...
                        <CarouselItem className="flex items-center justify-center w-fit h-[550px] ">
                            <div className="text-center space-y-6 text-white" onClick={() => route.push('/business/MPNP-EI')}>
                        ...
                        <CarouselItem className="flex items-center justify-center w-fit h-[550px] ">
                            <div className="text-center space-y-6 text-white" onClick={() => route.push('/business/NLPNP-EI')}>
