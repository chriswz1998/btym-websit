...
function UniversityRanking(){
    ...
    const rankings2 = [ {
        ...
        rank: 1,
        university: '西蒙弗雷泽大学',
        englishName: 'Simon Fraser',
        previousRank: 1
    }, { year: 2024, rank: 2, university: '维多利亚大学', englishName: 'Victoria', previousRank: 2 }, {
        year: 2024,
        rank: 3,
        university: '滑铁卢大学',
        englishName: 'Waterloo',
        previousRank: 3
    }, { year: 2024, rank: 4, university: '约克大学（加拿大）', englishName: 'York', previousRank: 5 }, {
        year: 2024,
        rank: 5,
        university: '卡尔顿大学',
        englishName: 'Carleton',
        previousRank: 5
    }, { year: 2024, rank: 5, university: '圭尔夫大学', englishName: 'Guelph', previousRank: 4 }, {
        year: 2024,
        rank: 7,
        university: '纽芬兰纪念大学',
        englishName: 'Memorial',
        previousRank: 7
    }, {
        year: 2024,
        rank: 8,
        university: '新布伦瑞克大学',
        englishName: 'New Brunswick',
        previousRank: 8
    }, {
        year: 2024,
        rank: 9,
        university: '康考迪亚大学（加拿大）',
        englishName: 'Concordia',
        previousRank: 10
    }, {
        year: 2024,
        rank: 10,
        university: '多伦多都市大学',
        englishName: 'Toronto Metropolitan',
        previousRank: 8
    }, {
        year: 2024,
        rank: 11,
        university: '威尔弗里德劳里埃大学',
        englishName: 'Wilfrid Laurier',
        previousRank: 10
    ...
    const rankings3 = [ {
        ...
        rank: 1,
        university: '蒙特爱立森大学',
        englishName: 'Mount Allison',
        previousRank: 1
    }, { year: 2024, rank: 2, university: '北英属哥伦比亚大学', englishName: 'UNBC', previousRank: 2 }, {
        year: 2024,
        rank: 3,
        university: '圣玛丽大学（加拿大）',
        englishName: 'Saint Mary\'s',
        previousRank: 3
    ...
    return (<div>
        ...
        <div className="p-10 space-y-10 bg-gray-100">
            <div className="flex space-x-4">
                <div className="bg-red-600 h-[80px] w-[5px]"/>
                <div className={ 'space-y-5 text-blue-950' }>
                    <div className="text-3xl font-bold">大学排名</div>
