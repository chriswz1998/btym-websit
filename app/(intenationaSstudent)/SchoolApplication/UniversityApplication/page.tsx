    ...
    return (<div>
        ...
        <div className="relative w-full h-[600px] overflow-hidden">
            ...
            <div
                ...
                <p className="text-white text-5xl font-bold">大学申请</p>
                <p className="text-white text-4xl font-bold">University Application</p>
            </div>
        </div>
        <div className="p-10 space-y-10 bg-gray-50 border-b">
            ...
            <div className="flex justify-evenly">
                <div className="w-full bg-white p-4 shadow rounded-lg space-y-4">
                    <p>学术成绩：如高中成绩、高考成绩、会考成绩平均在85%以上，88%以上有竞争力</p>
                    <p>语言成绩：雅思6.5，单项不低于6.0 ，托福 86以上，单项不低于22</p>
                    <p>经济担保：60万人民币以上</p>
                </div>
            </div>
        </div>
